    ...
    <div className="py-12"><h2 className="text-center  text-2xl md:text-3xl lg:text-4xl text-slate-800 md:font-semibold">Features our users love</h2>
      <div className="grid py-5 mt-6 gap-8 gap-y-12 lg:grid-cols-3 ">
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/1.svg"} width={70} height={70} />
        ...
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/2.svg"} width={70} height={70} />
        ...
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/3.svg"} width={70} height={70} />
        ...
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/4.svg"} width={70} height={70}/>
        ...
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/5.svg"} width={70} height={70} />
        ...
        <div className="text-center justify-center  flex flex-col items-center space-y-3">
          <Image alt="img" src={"/features/6.svg"} width={70} height={70} />
